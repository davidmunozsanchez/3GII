...
;;;Ejercicio: se añade variable edad
...
;;;Se añaden conjuntos difusos relacionados con edad
...
(cd edad mayor 17 18 100 100)
)

;; Definimos las reglas y las explicaciones asociadas
;;Las reglas 5 y 6 tienen en cuenta a edad
(deffacts reglas
...
(regla 5 explicacion "Si la temperatura es alta y es mayor de edad, la dosis a aplicar es alta")
(regla 6 antecedente temperatura alta)
(regla 6 antecedente edad menor)
(regla 6 consecuente dosis baja)
(regla 6 explicacion "Si es menor de edad y la temperatrua es alta, la dosis a aplicar es baja")
)
