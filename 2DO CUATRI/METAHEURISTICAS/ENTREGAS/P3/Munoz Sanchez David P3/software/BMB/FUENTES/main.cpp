...
int main(int argc, char **argv)
{
    ...
    //Tenemos que generar 10 soluciones iniciales aleatorias
    //como son aleatorias, no podemos garantizar que se incluyan
    //siempre soluciones distintas
    while (contador_soluciones < NUM_SOLUCIONES)
    {
        ...
        soluciones_iniciales.push_back(solucion_inicial);
