...
public:
  ComportamientoJugador(unsigned int size) : Comportamiento(size)
  {
    ...
    zapatillas = false;
    contador_giros = 0;
    primer_paso = true; //para copiar los precipicios al mapa resultado antes de nada
  }
...
private:
  ...
  bool girar_derecha;
  bool bien_situado;
  //si nivel 0, estamos bien situados
  bool bikini;
  bool zapatillas;
  int contador_giros;
  ...
  //Declaración de varias funciones auxiliares.
  void noPrimerPaso();
  bool zonaPrometedoraPos(Sensores sensores);
  bool zonaPrometedoraBik(Sensores sensores);
  bool zonaPrometedoraDep (Sensores sensores);
  bool puedeAvanzar(Sensores sensores);
  void setZapas(bool estado);
  void setBik(bool estado);
